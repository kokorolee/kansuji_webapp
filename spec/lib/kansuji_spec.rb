...
describe 'Kansuji' do
  ...
  context '10 ** 24 ' do
    it '1000000000000000000000000' do
      '1000000000000000000000000'.to_kansuji.should == '一禾予'
    end
    it '01000000000000000000000000' do
      '01000000000000000000000000'.to_kansuji.should == '一禾予'
    end
    it '1000000000000000000000001' do
      '1000000000000000000000001'.to_kansuji.should == '一禾予一'
    end
    it '1000000000000100000001001' do
      '1000000000000100000001001'.to_kansuji.should == '一禾予千億千一'
    end
    it '4000006000000000000000000' do
      '4000006000000000000000000'.to_kansuji.should == '四禾予六百京'
    end
    it '5095857806951230410954699' do
      '5095857806951230410954699'.to_kansuji.should == '五禾予九百五十八垓五千七百八十京六千九百五十一兆二千三百四億千九十五万四千六百九十九'
    end
  end
end
